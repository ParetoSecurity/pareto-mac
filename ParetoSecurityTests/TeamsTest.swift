...
class TeamsTest: XCTestCase {
    ...
    override func setUp() {
        ...
        userDefaults.removePersistentDomain(forName: "debug-paretosecurity") // Clear before each test
    }

    override func tearDown() {
        userDefaults.removePersistentDomain(forName: "debug-paretosecurity") // Clear after each test
        super.tearDown()
    }
    ...
    func testTeamTicket() throws {
        ...
        let data = "eyJhbGciOiJSUzUxMiIsInR5cCI6IkpXVCJ9..sb8Q79nuIc0NQsiAye2VlLTZQJ5bxpE0r814Nla4zdPy8h_Iw026KXbx9WZo7qh9ZW9X7XXR7bEkk_T48cA7yjBS70amsEV1ZmgllOaHdhqFLqVhy4ny9IkvbqYqQa-pTHDrQ04wgFPr4EgE5Y2Ce6-8EfCGuJsN-OHZK-tmhgR1cJ7kiIundxDBdL-eZwLahx_jm495RBp08CgN0G7C7qIdr7BrM4N3Sz2UuuEoJK2SeAWEnNkD2XHk1617HjCv2lRfnjoKKNYZgemnE_uGBaSWAud2D90W8b5tqpbBV16dbzx_8Y9jVtmwmVfIOcB4RfMiPrcWbxVAUj9OBNvkCg"
        Defaults[.teamID] = ""
