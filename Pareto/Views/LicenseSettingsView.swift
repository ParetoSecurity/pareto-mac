    ...
    var body: some View {
        if AppInfo.Licensed {
            if !Defaults[.teamID].isEmpty {
                ...
                }.frame(width: 350, height: showBeta ? 120 : 50).padding(25)
            }
            ...
            VStack {
                ...
                Link("Learn more »",
                     destination: URL(string: "https://paretosecurity.com/pricing?cc_source=\(AppInfo.utmSource)&cc_medium=license-link")!)
